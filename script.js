...
var rgbrand = document.getElementById("random-rgb")
...
// change event: runs when 'enter' is pressed or when it gets input
...
function random4() {
  var rand1 = + randin1.value;
  var rand2 = + randin2.value;
  var rand = Math.random() * (rand1 - rand2) + rand2;
  rand = rand.toFixed(1);
  console.log(rand1);
...
// Check your understanding
  ...
  // 4. Complete the Random Color button. This should change the html background to a random rgb color.  Hint:  `rgb(34, 245, 128)` is a value rgb color, where the numbers each range from 0 to 255. You will need three random numbers, then you will need to create a string using those numbers.
     ...
     //var rgbString = `rgb(34, 245, 128)`;
         ...
         rgbrand.addEventListener("click", colourrandom)
        ...
        function colourrandom (){
          ...
          function randsize(){
            var randomfont = Math.floor(Math.random() * 75);
            document.getElementById("body").style.fontsize = randomfont + "px";
            console.log(randfont)
          }
          document.getElementById("reset").addEventListener("click", reset);
          function reset() { 
            num = 0; numOutput.innerHTML = num; 
            story = "once upon a time, "; 
            stringOutEl.innerHTML = story; 
            stringInEl.value = "";
          rand1out.innerHTML = "----------"; 
             rand2out.innerHTML = "----------"; rand3out.innerHTML = "----------"; 
